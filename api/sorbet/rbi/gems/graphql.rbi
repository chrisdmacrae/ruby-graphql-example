...
class GraphQL::Execution::Interpreter::Runtime
  ...
  def after_lazy(lazy_obj, owner:, field:, path:, scoped_context:, owner_object:, arguments:, ast_node:, eager: nil, trace: nil, &block); end
  ...
  def final_value; end
  def gather_selections(owner_object, owner_type, selections, selections_by_name = nil); end
...
class GraphQL::Pagination::Connection
  ...
  def initialize(items, parent: nil, field: nil, context: nil, first: nil, after: nil, max_page_size: nil, last: nil, before: nil, edge_class: nil); end
  def items; end
  def last; end
  def last=(arg0); end
  def last_value; end
...
class GraphQL::Schema
  ...
  def self.add_directives_from(owner); end
...
class GraphQL::Schema::Validator::NumericalityValidator < GraphQL::Schema::Validator
  def initialize(greater_than: nil, greater_than_or_equal_to: nil, less_than: nil, less_than_or_equal_to: nil, equal_to: nil, other_than: nil, odd: nil, even: nil, message: nil, **default_options); end
  def validate(object, context, value); end
end
...
module InvalidName___Class_0x00___ResolveTypeWithType_30
...
module GraphQL::Types::Relay::ConnectionBehaviors::ClassMethods
  ...
  def define_nodes_field(nullable); end
  def edge_class; end
  def edge_type(edge_type_class, edge_class: nil, node_type: nil, nodes_field: nil, node_nullable: nil); end
  def node_nullable(new_value = nil); end
  def node_type; end
  def nodes_field(node_nullable: nil); end
  def scope_items(items, context); end
  def visible?(ctx); end
end
...
module GraphQL::Types::Relay::EdgeBehaviors::ClassMethods
  def accessible?(ctx); end
  def authorized?(obj, ctx); end
  def node_type(node_type = nil, null: nil); end
  def visible?(ctx); end
end
...
class GraphQL::Backtrace
  ...
  def inspect; end
  def self.use(schema_defn, legacy: nil); end
  def to_a; end
  def to_s; end
  extend Forwardable
  include Enumerable
