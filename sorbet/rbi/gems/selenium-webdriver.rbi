...
class Selenium::WebDriver::Interactions::PointerMove < Selenium::WebDriver::Interactions::Interaction
  def assert_source(source); end
  def encode; end
  def initialize(source, duration, x, y, element: nil, origin: nil, **opts); end
...
module Selenium::WebDriver::PointerActions
  ...
  def move_to(element, right_by = nil, down_by = nil, device: nil, duration: nil, **opts); end
...
class Selenium::WebDriver::Interactions::Scroll < Selenium::WebDriver::Interactions::Interaction
  def assert_source(source); end
  def encode; end
  def initialize(source:, x: nil, y: nil, delta_x: nil, delta_y: nil, origin: nil, duration: nil); end
end
...
class Selenium::WebDriver::ActionBuilder
  ...
  def deprecate_method(device = nil, duration = nil, number = nil, method: nil); end
  def device(name: nil, type: nil); end
  def devices; end
  def get_device(name); end
  def initialize(bridge, deprecated_mouse = nil, deprecated_keyboard = nil, deprecated_async = nil, devices: nil, async: nil, duration: nil); end
  def key_inputs; end
  def pause(deprecated_device = nil, deprecated_duration = nil, device: nil, duration: nil); end
  def pauses(deprecated_device = nil, deprecated_number = nil, deprecated_duration = nil, device: nil, number: nil, duration: nil); end
  def perform; end
